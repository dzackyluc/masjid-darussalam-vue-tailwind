   ...
   <div class="bg-white rounded-3xl mb-24 md:text-6xl font-bold items-center md:-mt-20 -mt-96 w-1/2 m-auto md:h-40 h-20 drop-shadow-md flex justify-center text-green-800">
    ...
    <div class="p-16 pb-28">
        ...
        <div class="container px-20 flex justify-around">
            <div>
                <button @click="$router.push('/galeri');" class=" bg-[#F6EFE5] hover:bg-green-800  border-black w-96 h-96">
                    <i class="pi pi-images text-3xl"></i>
                    <div class="text-center text-xl pt-4">Galeri</div>
                </button>
            </div>
            <div>
                <button @click="$router.push('/infaq')" class=" bg-[#F6EFE5] hover:bg-green-600 border-black 96 h-96">
