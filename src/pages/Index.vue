<template>
    <AppBar />
        <div class="background-image md:bg-cover bg-contain bg-no-repeat h-screen w-full">
        </div>
    <div class="bg-white flex rounded-3xl mb-24 md:text-xl items-center md:-mt-20 -mt-96 w-1/2 m-auto md:h-40 h-20 drop-shadow-md cursor-pointer transition transform hover:-translate-y-1 hover:scale-103 duration-300 justify-center text-green-800">
        <div class="img-profile m-5" style="width:350px">
            <img src="../assets/sholat.png" alt="Sholat Image" style=" object-fit: cover;border-radius: 10px;">
        </div>
        <div class="detail-card p-3">
            <div class="header font-semibold text-2xl mb-2">
                <h1>Masjid Jami' Darussalam</h1>
            </div>
            <div class="text-gray-500 text-base long-and-truncated justify-start" style="font-size: 15px;">Selamat datang di Masjid Jami Darussalam, sebuah tempat ibadah yang telah menjadi simbol kedamaian selama hampir lima tahun. Di tengah arus waktu yang tak kenal henti, Masjid Jami Daruussalam berdiri sebagai titik tenang. 
            </div>
        </div>
    </div>  
    <div class="grid md:grid-cols-4 grid-cols-2 my-28 md:mx-20 w-11/12">
        <div class="col-span-2 font-bold text-wrap text-xl md:text-2xl">Jadwal sholat di daerah terdekat anda.</div>
    ...
    <div class="grid md:grid-cols-4 grid-cols-2 m-auto gap-28 w-11/12">
        <div class="p-5 col-span-2">
            <div class="bg-white mb-5 drop-shadow-md flex-1 border rounded-lg p-5">
                <div v-if="Fajr" v-for="(item, key, index) in Fajr" :key="index" class="bg-[#4E6F52] text-white border my-3 rounded-lg w-full">
                    <div class="flex px-7  items-center justify-between h-14">
                        <div class="text-white font-bold col-span-1 text-2xl m-3 flex items-center gap-3">
                            <div>
                        ...
                        <div class="text-white col-span-1 text-end text-xl m-3 ">{{ item[1] }}</div>
                    </div>
                </div>
...
<style scoped>
.background-image {
  background-image: url("../assets/mosque-bg.jpg");
