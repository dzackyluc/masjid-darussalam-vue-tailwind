<template>
    ...
    <div class="container p-16">
        ...
        <div class="container pt-20 flex justify-around">
            <div>
                <button @click="this.$router.push('/galeri');" class="border bg-red-100 hover:bg-green-600 border-black w-32 h-32 rounded-full">
                    <i class="pi pi-images text-3xl"></i>
                </button>
                <div class="text-center text-xl pt-4">Galeri</div>
            </div>
            <div>
                <button @click="this.$router.push('/reservasi')" class="border bg-red-100 hover:bg-green-600 border-black w-32 h-32 flex items-center justify-center rounded-full">
            ...
            <div>
                <button @click="this.$router.push('/infaq')" class="border bg-red-100 hover:bg-green-600 border-black w-32 h-32 rounded-full">
                    <i class="pi pi-money-bill text-3xl"></i>
                </button>
                <div class="text-center text-xl pt-4">Infaq</div>
            </div>
            <div>
                <button @click="this.$router.push('/zakat')" class="border bg-red-100 hover:bg-green-600 border-black w-32 h-32 flex items-center justify-center rounded-full">
